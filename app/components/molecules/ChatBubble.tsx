...
const ChatBubble: React.FC<ChatBubbleProps> = ({ content, delay = 0, trianglePosition = 'center-bottom', icon, style }) => {
  let triangleStyles = '';
  ...
  return (
    ...
    >
      <div className={`absolute mb-2 w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] border-t-white ${triangleStyles}`} />
      {icon && <div className='w-6 h-6 rounded-full bg-cyan-100 flex justify-center items-center'><img src={icon} alt="" /></div>}
