            ...
            subtitle={
              <>
                ...
                <div className='hidden md:py-4 md:block'>
                  <Link href="/contact" className="underline">개발자가 필요하신가요?</Link>
                </div>
              </>
            }
          />
              ...
              {swiperCards.map((card, index) => {
                ...
                return (
                  <Card
                    ...
                    className={isCenterCard ? "absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 p-2" : "p-0 md:p-2"}
